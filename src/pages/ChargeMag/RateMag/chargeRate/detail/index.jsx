        ...
        <div>
            <Card>
                ...
                <Descriptions title="基本信息">
                    ...
                    <Descriptions.Item label="最低限额(分)">Hangzhou, Zhejiang</Descriptions.Item>
            ...
            <Card title='电费时段'  style={{marginTop:10,marginBottom:10}}>
                <Button type='primary' onClick={show1} style={{marginBottom:10}}>添加电费时段</Button>
                <Table
                    columns={columns1}
                    dataSource={data1}
                    bordered
